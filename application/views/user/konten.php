<section class="ftco-section ftco-product">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<h1 class="big">Jenis Pakaian</h1>
            <h2 class="mb-4">Laundryable</h2>
          </div>
        </div>
    		<div class="row">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-5 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Best <br>Cheapest <br> <span>Laundry Platform</span></h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
				<div class="row justify-content-center mb-3 pb-3">
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<h1 class="big">Parfume</h1>
            <h2 class="mb-4">Our Parfume</h2>
          </div>
        </div>    		
    	</div>
    ...
    <script>
       $.getJSON("<?=base_url()?>index.php/getall/pakaian", function(data){
           var datanya = "";
           $.each(data, function(key,dt){
               datanya += '<div class="col-md-4" style="float:left">'+
               '<div class="card product" style="width: 18rem; height:400px">'+
		    					'<img class="card-img-top" src="<?=base_url('assets/uploads/pakaian/')?>'+dt['gambar']+'" style="height:250px">'+
		    					'<div class="card-body text py-3 px-3">'+
		    						'<h5 class="card-title"><'+dt['jenis_pakaian']+'</h3>'+
			    					'<h3>Harga perkilo : '+dt['harga']+'</h3>'+
                                    '<hr>'+
                                    '<p class="bottom-area d-flex">'+
                                    '<a href="#" class="add-to-cart"><span>Add to cart <i class="ion-ios-add ml-1"></i></span></a>'+
                                   ' <a href="#" class="ml-auto"><span><i class="ion-ios-heart-empty"></i></span></a>'+
